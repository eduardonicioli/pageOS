...
define('DB_HOST', '-----------'); // Geralmente é 'localhost', mas verifique no seu painel serv00.net
define('DB_USER', '-------');   // EX: 'uXXXXX_usuario_bd'
define('DB_PASS', '--------');     // EX: 'SenhaForte123'
define('DB_NAME', '-------');     // EX: 'uXXXXX_nome_do_banco'
