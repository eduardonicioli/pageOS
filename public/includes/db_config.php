...
define('DB_HOST', 'xxxxxxxxxxxxx'); // Geralmente é 'localhost', mas verifique no seu painel serv00.net
define('DB_USER', 'xxxxxxxxxxxxx');   // EX: 'uXXXXX_usuario_bd'
define('DB_PASS', 'xxxxxxxxxxxxx');     // EX: 'SenhaForte123'
define('DB_NAME', 'xxxxxxxxxxxxx');     // EX: 'uXXXXX_nome_do_banco'
